/**
 * FingerprintJS Server API Node.js SDK v3.0.0 - Copyright (c) FingerprintJS, Inc, 2024 (https://fingerprint.com)
...
var fetchFn__default = /*#__PURE__*/_interopDefaultLegacy(fetchFn);
...
class FingerprintJsServerApiClient {
    ...
    constructor(options) {
        ...
        this.fetch = (_b = options.fetch) !== null && _b !== void 0 ? _b : fetchFn__default["default"];
    }
    getEvent(requestId) {
